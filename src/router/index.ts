...
const routes: RouteRecordRaw[] = [
        ...
        children: [
            {
                path: "userList",
                name: "userList",
                component: () => import("@/pages/newUserInfo/userList.vue"),
            ...
            },
            {
                ...
                name: "userEnrollList",
                component: () =>
                    import("@/pages/newUserInfo/userEnrollList.vue"),
                meta: { title: "用户报名列表", icon: "List" },
            },
        ],
    },
    {
    ...
    },
    {
        path: "/growthSystem",
        component: Layout,
        redirect: "/growthSystem/integralConfig",
        name: "GrowthSystem",
        ...
        children: [
            ...
            },
            {
                path: "userLevel",
                name: "UserLevel",
                component: () => import("@/pages/growthSystem/userLevel.vue"),
                meta: { title: "用户等级", icon: "TrendCharts" },
            },
            {
                path: "signConfig",
                name: "SignConfig",
                component: () => import("@/pages/growthSystem/signConfig.vue"),
                meta: { title: "签到配置", icon: "Calendar" },
            },
            {
                path: "signRecord",
                name: "SignRecord",
                component: () => import("@/pages/growthSystem/signRecord.vue"),
                meta: { title: "签到记录", icon: "Document" },
            },
            {
                path: "badge",
                name: "Badge",
                redirect: "/growthSystem/badge/grant",
                meta: { title: "徽章管理", icon: "Medal" },
                children: [
                    {
                        path: "grant",
            ...
            },
            {
                path: "ranking",
                name: "Ranking",
                component: () => import("@/pages/growthSystem/ranking.vue"),
